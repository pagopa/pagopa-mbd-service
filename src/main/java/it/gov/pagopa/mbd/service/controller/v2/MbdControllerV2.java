package it.gov.pagopa.mbd.service.controller.v2;
...
@Tag(name = "MBD - v2", description = "APIs for @eBollo v2")
@RestController
@RequestMapping(ApiPaths.V2_BASE)
public class MbdControllerV2 {
  ...
  public MbdControllerV2(MbdService mdbService) {
  ...
  public Mono<ResponseEntity<?>> createMbdV2(
    ...
    return mdbService
        .createMbdV2(organizationFiscalCode, request)
  ...
  @GetMapping(value = ApiPaths.V2_MBD_RECEIPT, produces = MediaType.APPLICATION_JSON_VALUE)
